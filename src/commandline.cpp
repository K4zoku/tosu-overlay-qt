...
CommandLineParser::CommandLineParser()
    : QCommandLineParser(),
      optionUrl(QStringList() << "t" << "tosu-url", QApplication::translate("main", "Base url to tosu instance."),
                "tosu-url", "http://127.0.0.1:24050"),
      optionMonitor(
...
CommandLineParseResult CommandLineParser::parseCommandLine() {
  ...
  CommandLineParserFunction parsers[] = {&CommandLineParser::parseCommonOptions, &CommandLineParser::parseIpcOption,
